    ...
    <div className="flex justify-center items-center h-screen">
      <Card>
        <CardHeader>
          ...
          <CardDescription>Sign up to see photos and videos frm your friends.
          </CardDescription>
        </CardHeader>
        <CardContent className="space-y-4">
          ...
          <Input type="email" value={email} onChange={email1} placeholder="Email" />
          {emailError && <div className="text-red-500 text-small">hooson bn</div>}
          <Input value={password} onChange={password1} placeholder="Password" />
          {passwordError && <div className="text-red-500 text-small">Hooson bn</div>}
        </CardContent>
        <CardFooter>
          <Button type="submit" onClick={signup} disabled={false}>Signup</Button>
        </CardFooter>
      </Card>
    </div>
  )
